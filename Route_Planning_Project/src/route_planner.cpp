...
// To Sort Nodes Bases on Sum of h and g values
bool CompareNodes(RouteModel::Node *FirstNode, RouteModel::Node *SecondNode){
    float First_Node_Sum = FirstNode->g_value + FirstNode->h_value;
    float Second_Node_Sum = SecondNode->g_value + SecondNode->h_value;
    return (First_Node_Sum > Second_Node_Sum);
}
